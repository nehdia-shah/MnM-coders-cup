    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Comprehensive insights into your microfinance operations
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">PKR 45.2K</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Healthy loans</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Advanced analytics features including trend analysis, predictive modeling, and custom reports are under development.
          </p>
        </CardContent>
      </Card>
    </div>
